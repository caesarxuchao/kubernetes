...
func BuildGenericConfig(s *options.ServerRunOptions, proxyTransport *http.Transport) (*genericapiserver.Config, informers.SharedInformerFactory, clientgoinformers.SharedInformerFactory, *kubeserver.InsecureServingInfo, aggregatorapiserver.ServiceResolver, error) {
	...
	webhookAuthResolver := func(delegate config.AuthenticationInfoResolver) config.AuthenticationInfoResolver {
		return config.AuthenticationInfoResolverFunc(func(server string) (*rest.Config, error) {
...
func BuildAdmissionPluginInitializer(s *options.ServerRunOptions, client internalclientset.Interface, sharedInformers informers.SharedInformerFactory, serviceResolver aggregatorapiserver.ServiceResolver, webhookAuthWrapper config.AuthenticationInfoResolverWrapper) (admission.PluginInitializer, error) {
