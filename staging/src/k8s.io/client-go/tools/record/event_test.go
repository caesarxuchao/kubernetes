...
func TestEventf(t *testing.T) {
	...
	testRef, err := v1.GetPartialReference(scheme.Scheme, testPod, "spec.containers[2]")
	testRef2, err := v1.GetPartialReference(scheme.Scheme, testPod2, "spec.containers[3]")
	if err != nil {
		t.Fatal(err)
	}
	table := []struct {
