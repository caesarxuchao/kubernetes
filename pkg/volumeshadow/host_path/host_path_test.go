...
func TestCanSupport(t *testing.T) {
	...
	plugMgr.InitPlugins(ProbeVolumePlugins(volumeshadow.VolumeConfig{}), volumetest.NewFakeVolumeHost("fake", nil, nil, "" /* rootContext */))
	...
	if !plug.CanSupport(&volumeshadow.Spec{Volume: &v1.Volume{VolumeSource: v1.VolumeSource{HostPath: &v1.HostPathVolumeSource{}}}}) {
		t.Errorf("Expected true")
	}
	if !plug.CanSupport(&volumeshadow.Spec{PersistentVolume: &v1.PersistentVolume{Spec: v1.PersistentVolumeSpec{PersistentVolumeSource: v1.PersistentVolumeSource{HostPath: &v1.HostPathVolumeSource{}}}}}) {
		t.Errorf("Expected true")
	}
...
func TestGetAccessModes(t *testing.T) {
	plugMgr := volumeshadow.VolumePluginMgr{}
	plugMgr.InitPlugins(ProbeVolumePlugins(volumeshadow.VolumeConfig{}), volumetest.NewFakeVolumeHost("/tmp/fake", nil, nil, "" /* rootContext */))
...
func TestRecycler(t *testing.T) {
	...
	plugMgr.InitPlugins([]volumeshadow.VolumePlugin{&hostPathPlugin{nil, volumetest.NewFakeRecycler, nil, nil, volumeshadow.VolumeConfig{}}}, pluginHost)

	spec := &volumeshadow.Spec{PersistentVolume: &v1.PersistentVolume{Spec: v1.PersistentVolumeSpec{PersistentVolumeSource: v1.PersistentVolumeSource{HostPath: &v1.HostPathVolumeSource{Path: "/foo"}}}}}
...
func TestDeleter(t *testing.T) {
	...
	spec := &volumeshadow.Spec{PersistentVolume: &v1.PersistentVolume{Spec: v1.PersistentVolumeSpec{PersistentVolumeSource: v1.PersistentVolumeSource{HostPath: &v1.HostPathVolumeSource{Path: tempPath}}}}}
...
func TestDeleterTempDir(t *testing.T) {
	...
	for name, test := range tests {
		plugMgr := volumeshadow.VolumePluginMgr{}
		plugMgr.InitPlugins(ProbeVolumePlugins(volumeshadow.VolumeConfig{}), volumetest.NewFakeVolumeHost("/tmp/fake", nil, nil, "" /* rootContext */))
		spec := &volumeshadow.Spec{PersistentVolume: &v1.PersistentVolume{Spec: v1.PersistentVolumeSpec{PersistentVolumeSource: v1.PersistentVolumeSource{HostPath: &v1.HostPathVolumeSource{Path: test.path}}}}}
...
func TestProvisioner(t *testing.T) {
	...
	plugMgr := volumeshadow.VolumePluginMgr{}
	plugMgr.InitPlugins(ProbeVolumePlugins(volumeshadow.VolumeConfig{ProvisioningEnabled: true}),
	...
	creater, err := plug.NewProvisioner(volumeshadow.VolumeOptions{Capacity: resource.MustParse("1Gi"), PersistentVolumeReclaimPolicy: v1.PersistentVolumeReclaimDelete})
	if err != nil {
...
func TestPlugin(t *testing.T) {
	...
	mounter, err := plug.NewMounter(volumeshadow.NewSpecFromVolume(spec), pod, volumeshadow.VolumeOptions{})
	if err != nil {
...
func TestPersistentClaimReadOnlyFlag(t *testing.T) {
	...
	plugMgr := volumeshadow.VolumePluginMgr{}
	plugMgr.InitPlugins(ProbeVolumePlugins(volumeshadow.VolumeConfig{}), volumetest.NewFakeVolumeHost("/tmp/fake", client, nil, "" /* rootContext */))
