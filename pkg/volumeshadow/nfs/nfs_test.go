...
func TestCanSupport(t *testing.T) {
	...
	plugMgr.InitPlugins(ProbeVolumePlugins(volumeshadow.VolumeConfig{}), volumetest.NewFakeVolumeHost(tmpDir, nil, nil, "" /* rootContext */))
	...
	if !plug.CanSupport(&volumeshadow.Spec{Volume: &v1.Volume{VolumeSource: v1.VolumeSource{NFS: &v1.NFSVolumeSource{}}}}) {
		t.Errorf("Expected true")
	}
	if !plug.CanSupport(&volumeshadow.Spec{PersistentVolume: &v1.PersistentVolume{Spec: v1.PersistentVolumeSpec{PersistentVolumeSource: v1.PersistentVolumeSource{NFS: &v1.NFSVolumeSource{}}}}}) {
		t.Errorf("Expected true")
	}
...
func TestRecycler(t *testing.T) {
	...
	plugMgr := volumeshadow.VolumePluginMgr{}
	plugMgr.InitPlugins([]volumeshadow.VolumePlugin{&nfsPlugin{nil, newMockRecycler, volumeshadow.VolumeConfig{}}}, volumetest.NewFakeVolumeHost(tmpDir, nil, nil, "" /* rootContext */))

	spec := &volumeshadow.Spec{PersistentVolume: &v1.PersistentVolume{Spec: v1.PersistentVolumeSpec{PersistentVolumeSource: v1.PersistentVolumeSource{NFS: &v1.NFSVolumeSource{Path: "/foo"}}}}}
...
func newMockRecycler(pvName string, spec *volumeshadow.Spec, eventRecorder volumeshadow.RecycleEventRecorder, host volumeshadow.VolumeHost, config volumeshadow.VolumeConfig) (volumeshadow.Recycler, error) {
	return &mockRecycler{
...
func TestPersistentClaimReadOnlyFlag(t *testing.T) {
	...
	plugMgr := volumeshadow.VolumePluginMgr{}
	plugMgr.InitPlugins(ProbeVolumePlugins(volumeshadow.VolumeConfig{}), volumetest.NewFakeVolumeHost(tmpDir, client, nil, "" /* rootContext */))
