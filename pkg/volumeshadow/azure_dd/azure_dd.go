...
func ProbeVolumePlugins() []volumeshadow.VolumePlugin {
	return []volumeshadow.VolumePlugin{&azureDataDiskPlugin{}}
}
...
var _ volumeshadow.VolumePlugin = &azureDataDiskPlugin{}
var _ volumeshadow.PersistentVolumePlugin = &azureDataDiskPlugin{}

const (
	azureDataDiskPluginName = "kubernetes.io/azure-disk"
)

func (plugin *azureDataDiskPlugin) Init(host volumeshadow.VolumeHost) error {
	plugin.host = host
...
func (plugin *azureDataDiskPlugin) GetVolumeName(spec *volumeshadow.Spec) (string, error) {
...
func (plugin *azureDataDiskPlugin) CanSupport(spec *volumeshadow.Spec) bool {
...
func (plugin *azureDataDiskPlugin) NewMounter(spec *volumeshadow.Spec, pod *v1.Pod, _ volumeshadow.VolumeOptions) (volumeshadow.Mounter, error) {
	return plugin.newMounterInternal(spec, pod.UID, plugin.host.GetMounter())
}

func (plugin *azureDataDiskPlugin) newMounterInternal(spec *volumeshadow.Spec, podUID types.UID, mounter mount.Interface) (volumeshadow.Mounter, error) {
...
func (plugin *azureDataDiskPlugin) NewUnmounter(volName string, podUID types.UID) (volumeshadow.Unmounter, error) {
	return plugin.newUnmounterInternal(volName, podUID, plugin.host.GetMounter())
}

func (plugin *azureDataDiskPlugin) newUnmounterInternal(volName string, podUID types.UID, mounter mount.Interface) (volumeshadow.Unmounter, error) {
...
func (plugin *azureDataDiskPlugin) ConstructVolumeSpec(volName, mountPath string) (*volumeshadow.Spec, error) {
	...
	return volumeshadow.NewSpecFromVolume(azVolume), nil
}
...
var _ volumeshadow.Mounter = &azureDiskMounter{}

func (b *azureDiskMounter) GetAttributes() volumeshadow.Attributes {
...
func makeGlobalPDPath(host volumeshadow.VolumeHost, volume string) string {
...
var _ volumeshadow.Unmounter = &azureDiskUnmounter{}
...
func getVolumeSource(spec *volumeshadow.Spec) (*v1.AzureDiskVolumeSource, error) {
