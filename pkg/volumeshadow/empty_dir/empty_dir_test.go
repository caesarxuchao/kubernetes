...
func makePluginUnderTest(t *testing.T, plugName, basePath, rootContext string) volumeshadow.VolumePlugin {
...
func TestCanSupport(t *testing.T) {
	...
	if !plug.CanSupport(&volumeshadow.Spec{Volume: &v1.Volume{VolumeSource: v1.VolumeSource{EmptyDir: &v1.EmptyDirVolumeSource{}}}}) {
...
func doTestPlugin(t *testing.T, config pluginTestConfig) {
	...
	mounter, err := plug.(*emptyDirPlugin).newMounterInternal(volumeshadow.NewSpecFromVolume(spec),
		pod,
		&physicalMounter,
		&mountDetector,
