...
func ProbeVolumePlugins() []volumeshadow.VolumePlugin {
	return []volumeshadow.VolumePlugin{&vsphereVolumePlugin{}}
}
...
var _ volumeshadow.VolumePlugin = &vsphereVolumePlugin{}
var _ volumeshadow.PersistentVolumePlugin = &vsphereVolumePlugin{}
var _ volumeshadow.DeletableVolumePlugin = &vsphereVolumePlugin{}
var _ volumeshadow.ProvisionableVolumePlugin = &vsphereVolumePlugin{}
...
func (plugin *vsphereVolumePlugin) Init(host volumeshadow.VolumeHost) error {
	plugin.host = host
	return nil
}
...
func (plugin *vsphereVolumePlugin) GetVolumeName(spec *volumeshadow.Spec) (string, error) {
...
func (plugin *vsphereVolumePlugin) CanSupport(spec *volumeshadow.Spec) bool {
...
func (plugin *vsphereVolumePlugin) NewMounter(spec *volumeshadow.Spec, pod *v1.Pod, _ volumeshadow.VolumeOptions) (volumeshadow.Mounter, error) {
	return plugin.newMounterInternal(spec, pod.UID, &VsphereDiskUtil{}, plugin.host.GetMounter())
}

func (plugin *vsphereVolumePlugin) NewUnmounter(volName string, podUID types.UID) (volumeshadow.Unmounter, error) {
	return plugin.newUnmounterInternal(volName, podUID, &VsphereDiskUtil{}, plugin.host.GetMounter())
}

func (plugin *vsphereVolumePlugin) newMounterInternal(spec *volumeshadow.Spec, podUID types.UID, manager vdManager, mounter mount.Interface) (volumeshadow.Mounter, error) {
...
func (plugin *vsphereVolumePlugin) newUnmounterInternal(volName string, podUID types.UID, manager vdManager, mounter mount.Interface) (volumeshadow.Unmounter, error) {
...
func (plugin *vsphereVolumePlugin) ConstructVolumeSpec(volumeName, mountPath string) (*volumeshadow.Spec, error) {
	...
	return volumeshadow.NewSpecFromVolume(vsphereVolume), nil
}
...
var _ volumeshadow.Mounter = &vsphereVolumeMounter{}
...
func (b *vsphereVolumeMounter) GetAttributes() volumeshadow.Attributes {
...
var _ volumeshadow.Unmounter = &vsphereVolumeUnmounter{}
...
func makeGlobalPDPath(host volumeshadow.VolumeHost, devName string) string {
...
var _ volumeshadow.Deleter = &vsphereVolumeDeleter{}

func (plugin *vsphereVolumePlugin) NewDeleter(spec *volumeshadow.Spec) (volumeshadow.Deleter, error) {
	return plugin.newDeleterInternal(spec, &VsphereDiskUtil{})
}

func (plugin *vsphereVolumePlugin) newDeleterInternal(spec *volumeshadow.Spec, manager vdManager) (volumeshadow.Deleter, error) {
...
var _ volumeshadow.Provisioner = &vsphereVolumeProvisioner{}

func (plugin *vsphereVolumePlugin) NewProvisioner(options volumeshadow.VolumeOptions) (volumeshadow.Provisioner, error) {
...
func (plugin *vsphereVolumePlugin) newProvisionerInternal(options volumeshadow.VolumeOptions, manager vdManager) (volumeshadow.Provisioner, error) {
...
func getVolumeSource(
	spec *volumeshadow.Spec) (*v1.VsphereVirtualDiskVolumeSource, bool, error) {
