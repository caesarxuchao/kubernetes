...
func TestAttachDetach(t *testing.T) {
	...
	nodeName := k8stypes.NodeName("host")
...
func createVolSpec(name string) *volumeshadow.Spec {
...
func createPVSpec(name string) *volumeshadow.Spec {
	return &volumeshadow.Spec{
...
func (testcase *testcase) AttachDisk(diskName string, nodeName k8stypes.NodeName) (string, string, error) {
...
func (testcase *testcase) DetachDisk(diskName string, nodeName k8stypes.NodeName) error {
