...
func ProbeVolumePlugins(pluginDir string) []volumeshadow.VolumePlugin {
	plugins := []volumeshadow.VolumePlugin{}
...
func (plugin *flexVolumePlugin) Init(host volumeshadow.VolumeHost) error {
	plugin.host = host
...
func (plugin *flexVolumePlugin) GetVolumeName(spec *volumeshadow.Spec) (string, error) {
...
func (plugin *flexVolumePlugin) CanSupport(spec *volumeshadow.Spec) bool {
...
func (plugin *flexVolumePlugin) NewMounter(spec *volumeshadow.Spec, pod *v1.Pod, _ volumeshadow.VolumeOptions) (volumeshadow.Mounter, error) {
...
func (plugin *flexVolumePlugin) newMounterInternal(spec *volumeshadow.Spec, pod *v1.Pod, manager flexVolumeManager, mounter mount.Interface, runner exec.Interface, secrets map[string]string) (volumeshadow.Mounter, error) {
...
func (plugin *flexVolumePlugin) NewUnmounter(volName string, podUID types.UID) (volumeshadow.Unmounter, error) {
...
func (plugin *flexVolumePlugin) newUnmounterInternal(volName string, podUID types.UID, manager flexVolumeManager, mounter mount.Interface, runner exec.Interface) (volumeshadow.Unmounter, error) {
...
func (plugin *flexVolumePlugin) ConstructVolumeSpec(volumeName, sourceName string) (*volumeshadow.Spec, error) {
	...
	return volumeshadow.NewSpecFromVolume(flexVolume), nil
}
...
func (f flexVolumeMounter) GetAttributes() volumeshadow.Attributes {
...
func getVolumeSource(spec *volumeshadow.Spec) (*v1.FlexVolumeSource, bool, error) {
