...
import (
	...
	ioutil "k8s.io/kubernetes/pkg/volumeshadow/util"
)

// This is the primary entrypoint for volume plugins.
func ProbeVolumePlugins() []volumeshadow.VolumePlugin {
	return []volumeshadow.VolumePlugin{&iscsiPlugin{nil, exec.New()}}
}
...
var _ volumeshadow.VolumePlugin = &iscsiPlugin{}
var _ volumeshadow.PersistentVolumePlugin = &iscsiPlugin{}

const (
	iscsiPluginName = "kubernetes.io/iscsi"
)

func (plugin *iscsiPlugin) Init(host volumeshadow.VolumeHost) error {
	plugin.host = host
	return nil
}
...
func (plugin *iscsiPlugin) GetVolumeName(spec *volumeshadow.Spec) (string, error) {
...
func (plugin *iscsiPlugin) CanSupport(spec *volumeshadow.Spec) bool {
...
func (plugin *iscsiPlugin) NewMounter(spec *volumeshadow.Spec, pod *v1.Pod, _ volumeshadow.VolumeOptions) (volumeshadow.Mounter, error) {
	// Inject real implementations here, test through the internal function.
	return plugin.newMounterInternal(spec, pod.UID, &ISCSIUtil{}, plugin.host.GetMounter())
}

func (plugin *iscsiPlugin) newMounterInternal(spec *volumeshadow.Spec, podUID types.UID, manager diskManager, mounter mount.Interface) (volumeshadow.Mounter, error) {
...
func (plugin *iscsiPlugin) NewUnmounter(volName string, podUID types.UID) (volumeshadow.Unmounter, error) {
	// Inject real implementations here, test through the internal function.
	return plugin.newUnmounterInternal(volName, podUID, &ISCSIUtil{}, plugin.host.GetMounter())
}

func (plugin *iscsiPlugin) newUnmounterInternal(volName string, podUID types.UID, manager diskManager, mounter mount.Interface) (volumeshadow.Unmounter, error) {
...
func (plugin *iscsiPlugin) ConstructVolumeSpec(volumeName, mountPath string) (*volumeshadow.Spec, error) {
	...
	return volumeshadow.NewSpecFromVolume(iscsiVolume), nil
}
...
var _ volumeshadow.Mounter = &iscsiDiskMounter{}

func (b *iscsiDiskMounter) GetAttributes() volumeshadow.Attributes {
...
var _ volumeshadow.Unmounter = &iscsiDiskUnmounter{}
...
func getVolumeSource(spec *volumeshadow.Spec) (*v1.ISCSIVolumeSource, bool, error) {
