...
import (
	...
	"k8s.io/kubernetes/pkg/fieldpathshadow"
...
func ProbeVolumePlugins() []volumeshadow.VolumePlugin {
	return []volumeshadow.VolumePlugin{&downwardAPIPlugin{}}
}
...
var _ volumeshadow.VolumePlugin = &downwardAPIPlugin{}
...
func (plugin *downwardAPIPlugin) Init(host volumeshadow.VolumeHost) error {
	plugin.host = host
	return nil
}
...
func (plugin *downwardAPIPlugin) GetVolumeName(spec *volumeshadow.Spec) (string, error) {
...
func (plugin *downwardAPIPlugin) CanSupport(spec *volumeshadow.Spec) bool {
...
func (plugin *downwardAPIPlugin) NewMounter(spec *volumeshadow.Spec, pod *v1.Pod, opts volumeshadow.VolumeOptions) (volumeshadow.Mounter, error) {
	v := &downwardAPIVolume{
		volName: spec.Name(),
...
func (plugin *downwardAPIPlugin) NewUnmounter(volName string, podUID types.UID) (volumeshadow.Unmounter, error) {
...
func (plugin *downwardAPIPlugin) ConstructVolumeSpec(volumeName, mountPath string) (*volumeshadow.Spec, error) {
	...
	return volumeshadow.NewSpecFromVolume(downwardAPIVolume), nil
}
...
var _ volumeshadow.Mounter = &downwardAPIVolumeMounter{}

// downward API volumes are always ReadOnlyManaged
func (d *downwardAPIVolume) GetAttributes() volumeshadow.Attributes {
...
var _ volumeshadow.Unmounter = &downwardAPIVolumeUnmounter{}
...
func getVolumeSource(spec *volumeshadow.Spec) (*v1.DownwardAPIVolumeSource, bool) {
	var readOnly bool
