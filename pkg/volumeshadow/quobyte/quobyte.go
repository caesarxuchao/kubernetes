...
func ProbeVolumePlugins() []volumeshadow.VolumePlugin {
	return []volumeshadow.VolumePlugin{&quobytePlugin{nil}}
}
...
var _ volumeshadow.VolumePlugin = &quobytePlugin{}
var _ volumeshadow.PersistentVolumePlugin = &quobytePlugin{}
var _ volumeshadow.DeletableVolumePlugin = &quobytePlugin{}
var _ volumeshadow.ProvisionableVolumePlugin = &quobytePlugin{}
var _ volumeshadow.Provisioner = &quobyteVolumeProvisioner{}
var _ volumeshadow.Deleter = &quobyteVolumeDeleter{}
...
func (plugin *quobytePlugin) Init(host volumeshadow.VolumeHost) error {
	plugin.host = host
	return nil
}
...
func (plugin *quobytePlugin) GetVolumeName(spec *volumeshadow.Spec) (string, error) {
...
func (plugin *quobytePlugin) CanSupport(spec *volumeshadow.Spec) bool {
...
func getVolumeSource(spec *volumeshadow.Spec) (*v1.QuobyteVolumeSource, bool, error) {
...
func (plugin *quobytePlugin) ConstructVolumeSpec(volumeName, mountPath string) (*volumeshadow.Spec, error) {
	...
	return volumeshadow.NewSpecFromVolume(quobyteVolume), nil
}

func (plugin *quobytePlugin) NewMounter(spec *volumeshadow.Spec, pod *v1.Pod, _ volumeshadow.VolumeOptions) (volumeshadow.Mounter, error) {
	return plugin.newMounterInternal(spec, pod, plugin.host.GetMounter())
}

func (plugin *quobytePlugin) newMounterInternal(spec *volumeshadow.Spec, pod *v1.Pod, mounter mount.Interface) (volumeshadow.Mounter, error) {
...
func (plugin *quobytePlugin) NewUnmounter(volName string, podUID types.UID) (volumeshadow.Unmounter, error) {
	return plugin.newUnmounterInternal(volName, podUID, plugin.host.GetMounter())
}

func (plugin *quobytePlugin) newUnmounterInternal(volName string, podUID types.UID, mounter mount.Interface) (volumeshadow.Unmounter, error) {
...
var _ volumeshadow.Mounter = &quobyteMounter{}

func (mounter *quobyteMounter) GetAttributes() volumeshadow.Attributes {
...
var _ volumeshadow.Unmounter = &quobyteUnmounter{}
...
func (plugin *quobytePlugin) NewDeleter(spec *volumeshadow.Spec) (volumeshadow.Deleter, error) {
	if spec.PersistentVolume != nil && spec.PersistentVolume.Spec.Quobyte == nil {
...
func (plugin *quobytePlugin) newDeleterInternal(spec *volumeshadow.Spec) (volumeshadow.Deleter, error) {
	source, readOnly, err := getVolumeSource(spec)
	if err != nil {
		return nil, err
	}
...
func (plugin *quobytePlugin) NewProvisioner(options volumeshadow.VolumeOptions) (volumeshadow.Provisioner, error) {
...
func (plugin *quobytePlugin) newProvisionerInternal(options volumeshadow.VolumeOptions) (volumeshadow.Provisioner, error) {
