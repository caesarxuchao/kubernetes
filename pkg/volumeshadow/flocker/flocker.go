...
func ProbeVolumePlugins() []volumeshadow.VolumePlugin {
	return []volumeshadow.VolumePlugin{&flockerPlugin{nil}}
}
...
var _ volumeshadow.VolumePlugin = &flockerPlugin{}
var _ volumeshadow.PersistentVolumePlugin = &flockerPlugin{}
var _ volumeshadow.DeletableVolumePlugin = &flockerPlugin{}
var _ volumeshadow.ProvisionableVolumePlugin = &flockerPlugin{}
...
func (p *flockerPlugin) Init(host volumeshadow.VolumeHost) error {
	p.host = host
	return nil
}
...
func (p *flockerPlugin) GetVolumeName(spec *volumeshadow.Spec) (string, error) {
...
func (p *flockerPlugin) CanSupport(spec *volumeshadow.Spec) bool {
...
func (p *flockerPlugin) getFlockerVolumeSource(spec *volumeshadow.Spec) (*v1.FlockerVolumeSource, bool) {
...
func (plugin *flockerPlugin) NewMounter(spec *volumeshadow.Spec, pod *v1.Pod, _ volumeshadow.VolumeOptions) (volumeshadow.Mounter, error) {
	// Inject real implementations here, test through the internal function.
	return plugin.newMounterInternal(spec, pod.UID, &FlockerUtil{}, plugin.host.GetMounter())
}

func (plugin *flockerPlugin) newMounterInternal(spec *volumeshadow.Spec, podUID types.UID, manager volumeManager, mounter mount.Interface) (volumeshadow.Mounter, error) {
...
func (p *flockerPlugin) NewUnmounter(volName string, podUID types.UID) (volumeshadow.Unmounter, error) {
	// Inject real implementations here, test through the internal function.
	return p.newUnmounterInternal(volName, podUID, &FlockerUtil{}, p.host.GetMounter())
}

func (p *flockerPlugin) newUnmounterInternal(volName string, podUID types.UID, manager volumeManager, mounter mount.Interface) (volumeshadow.Unmounter, error) {
	return &flockerVolumeUnmounter{&flockerVolume{
		...
		mounter:         mounter,
		plugin:          p,
		MetricsProvider: volumeshadow.NewMetricsStatFS(getPath(podUID, volName, p.host)),
	}}, nil
}

func (p *flockerPlugin) ConstructVolumeSpec(volumeName, mountPath string) (*volumeshadow.Spec, error) {
	...
	return volumeshadow.NewSpecFromVolume(flockerVolume), nil
}
...
func (b *flockerVolumeMounter) GetAttributes() volumeshadow.Attributes {
...
func getVolumeSource(spec *volumeshadow.Spec) (*v1.FlockerVolumeSource, bool, error) {
	if spec.Volume != nil && spec.Volume.Flocker != nil {
...
var _ volumeshadow.Unmounter = &flockerVolumeUnmounter{}
...
func (plugin *flockerPlugin) NewDeleter(spec *volumeshadow.Spec) (volumeshadow.Deleter, error) {
	return plugin.newDeleterInternal(spec, &FlockerUtil{})
}

func (plugin *flockerPlugin) newDeleterInternal(spec *volumeshadow.Spec, manager volumeManager) (volumeshadow.Deleter, error) {
...
func (plugin *flockerPlugin) NewProvisioner(options volumeshadow.VolumeOptions) (volumeshadow.Provisioner, error) {
...
func (plugin *flockerPlugin) newProvisionerInternal(options volumeshadow.VolumeOptions, manager volumeManager) (volumeshadow.Provisioner, error) {
