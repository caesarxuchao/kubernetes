...
func ProbeVolumePlugins() []volumeshadow.VolumePlugin {
	return []volumeshadow.VolumePlugin{&awsElasticBlockStorePlugin{nil}}
}
...
var _ volumeshadow.VolumePlugin = &awsElasticBlockStorePlugin{}
var _ volumeshadow.PersistentVolumePlugin = &awsElasticBlockStorePlugin{}
var _ volumeshadow.DeletableVolumePlugin = &awsElasticBlockStorePlugin{}
var _ volumeshadow.ProvisionableVolumePlugin = &awsElasticBlockStorePlugin{}
...
func (plugin *awsElasticBlockStorePlugin) Init(host volumeshadow.VolumeHost) error {
	plugin.host = host
	return nil
}
...
func (plugin *awsElasticBlockStorePlugin) GetVolumeName(spec *volumeshadow.Spec) (string, error) {
...
func (plugin *awsElasticBlockStorePlugin) CanSupport(spec *volumeshadow.Spec) bool {
...
func (plugin *awsElasticBlockStorePlugin) NewMounter(spec *volumeshadow.Spec, pod *v1.Pod, _ volumeshadow.VolumeOptions) (volumeshadow.Mounter, error) {
	// Inject real implementations here, test through the internal function.
	return plugin.newMounterInternal(spec, pod.UID, &AWSDiskUtil{}, plugin.host.GetMounter())
}

func (plugin *awsElasticBlockStorePlugin) newMounterInternal(spec *volumeshadow.Spec, podUID types.UID, manager ebsManager, mounter mount.Interface) (volumeshadow.Mounter, error) {
	...
	return &awsElasticBlockStoreMounter{
		awsElasticBlockStore: &awsElasticBlockStore{
			...
			mounter:         mounter,
			plugin:          plugin,
			MetricsProvider: volumeshadow.NewMetricsStatFS(getPath(podUID, spec.Name(), plugin.host)),
		},
		fsType:      fsType,
		readOnly:    readOnly,
...
func (plugin *awsElasticBlockStorePlugin) NewUnmounter(volName string, podUID types.UID) (volumeshadow.Unmounter, error) {
	// Inject real implementations here, test through the internal function.
	return plugin.newUnmounterInternal(volName, podUID, &AWSDiskUtil{}, plugin.host.GetMounter())
}

func (plugin *awsElasticBlockStorePlugin) newUnmounterInternal(volName string, podUID types.UID, manager ebsManager, mounter mount.Interface) (volumeshadow.Unmounter, error) {
	return &awsElasticBlockStoreUnmounter{&awsElasticBlockStore{
		...
		mounter:         mounter,
		plugin:          plugin,
		MetricsProvider: volumeshadow.NewMetricsStatFS(getPath(podUID, volName, plugin.host)),
	}}, nil
}

func (plugin *awsElasticBlockStorePlugin) NewDeleter(spec *volumeshadow.Spec) (volumeshadow.Deleter, error) {
	return plugin.newDeleterInternal(spec, &AWSDiskUtil{})
}

func (plugin *awsElasticBlockStorePlugin) newDeleterInternal(spec *volumeshadow.Spec, manager ebsManager) (volumeshadow.Deleter, error) {
...
func (plugin *awsElasticBlockStorePlugin) NewProvisioner(options volumeshadow.VolumeOptions) (volumeshadow.Provisioner, error) {
...
func (plugin *awsElasticBlockStorePlugin) newProvisionerInternal(options volumeshadow.VolumeOptions, manager ebsManager) (volumeshadow.Provisioner, error) {
...
func getVolumeSource(
	spec *volumeshadow.Spec) (*v1.AWSElasticBlockStoreVolumeSource, bool, error) {
...
func (plugin *awsElasticBlockStorePlugin) ConstructVolumeSpec(volName, mountPath string) (*volumeshadow.Spec, error) {
	...
	return volumeshadow.NewSpecFromVolume(awsVolume), nil
}
...
var _ volumeshadow.Mounter = &awsElasticBlockStoreMounter{}

func (b *awsElasticBlockStoreMounter) GetAttributes() volumeshadow.Attributes {
...
func (b *awsElasticBlockStoreMounter) SetUpAt(dir string, fsGroup *int64) error {
	...
	if !b.readOnly {
		volumeshadow.SetVolumeOwnership(b, fsGroup)
	}
...
func makeGlobalPDPath(host volumeshadow.VolumeHost, volumeID string) string {
...
func getVolumeIDFromGlobalMount(host volumeshadow.VolumeHost, globalPath string) (string, error) {
...
var _ volumeshadow.Unmounter = &awsElasticBlockStoreUnmounter{}
...
var _ volumeshadow.Deleter = &awsElasticBlockStoreDeleter{}
...
var _ volumeshadow.Provisioner = &awsElasticBlockStoreProvisioner{}
