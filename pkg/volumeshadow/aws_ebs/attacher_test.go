...
func TestAttachDetach(t *testing.T) {
	diskName := "disk"
	nodeName := k8stypes.NodeName("instance")
	readOnly := false
...
func (testcase *testcase) AttachDisk(diskName string, nodeName k8stypes.NodeName, readOnly bool) (string, error) {
...
func (testcase *testcase) DetachDisk(diskName string, nodeName k8stypes.NodeName) (string, error) {
...
func (testcase *testcase) DiskIsAttached(diskName string, nodeName k8stypes.NodeName) (bool, error) {
