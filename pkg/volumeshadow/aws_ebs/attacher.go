...
var _ volumeshadow.Attacher = &awsElasticBlockStoreAttacher{}

var _ volumeshadow.AttachableVolumePlugin = &awsElasticBlockStorePlugin{}

func (plugin *awsElasticBlockStorePlugin) NewAttacher() (volumeshadow.Attacher, error) {
...
func (attacher *awsElasticBlockStoreAttacher) Attach(spec *volumeshadow.Spec, nodeName k8stypes.NodeName) (string, error) {
...
func (attacher *awsElasticBlockStoreAttacher) WaitForAttach(spec *volumeshadow.Spec, devicePath string, timeout time.Duration) (string, error) {
...
func (attacher *awsElasticBlockStoreAttacher) GetDeviceMountPath(
	spec *volumeshadow.Spec) (string, error) {
	volumeSource, _, err := getVolumeSource(spec)
	if err != nil {
		return "", err
	}
...
func (attacher *awsElasticBlockStoreAttacher) MountDevice(spec *volumeshadow.Spec, devicePath string, deviceMountPath string) error {
...
var _ volumeshadow.Detacher = &awsElasticBlockStoreDetacher{}

func (plugin *awsElasticBlockStorePlugin) NewDetacher() (volumeshadow.Detacher, error) {
	awsCloud, err := getCloudProvider(plugin.host.GetCloudProvider())
	if err != nil {
		return nil, err
	}
...
func (detacher *awsElasticBlockStoreDetacher) Detach(deviceMountPath string, nodeName k8stypes.NodeName) error {
