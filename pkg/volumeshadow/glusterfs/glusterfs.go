...
func ProbeVolumePlugins() []volumeshadow.VolumePlugin {
	return []volumeshadow.VolumePlugin{&glusterfsPlugin{nil, exec.New()}}
}
...
var _ volumeshadow.VolumePlugin = &glusterfsPlugin{}
var _ volumeshadow.PersistentVolumePlugin = &glusterfsPlugin{}
var _ volumeshadow.DeletableVolumePlugin = &glusterfsPlugin{}
var _ volumeshadow.ProvisionableVolumePlugin = &glusterfsPlugin{}
var _ volumeshadow.Provisioner = &glusterfsVolumeProvisioner{}
var _ volumeshadow.Deleter = &glusterfsVolumeDeleter{}
...
func (plugin *glusterfsPlugin) Init(host volumeshadow.VolumeHost) error {
	plugin.host = host
	return nil
}
...
func (plugin *glusterfsPlugin) GetVolumeName(spec *volumeshadow.Spec) (string, error) {
...
func (plugin *glusterfsPlugin) CanSupport(spec *volumeshadow.Spec) bool {
...
func (plugin *glusterfsPlugin) NewMounter(spec *volumeshadow.Spec, pod *v1.Pod, _ volumeshadow.VolumeOptions) (volumeshadow.Mounter, error) {
...
func (plugin *glusterfsPlugin) getGlusterVolumeSource(spec *volumeshadow.Spec) (*v1.GlusterfsVolumeSource, bool) {
...
func (plugin *glusterfsPlugin) newMounterInternal(spec *volumeshadow.Spec, ep *v1.Endpoints, pod *v1.Pod, mounter mount.Interface, exe exec.Interface) (volumeshadow.Mounter, error) {
...
func (plugin *glusterfsPlugin) NewUnmounter(volName string, podUID types.UID) (volumeshadow.Unmounter, error) {
	return plugin.newUnmounterInternal(volName, podUID, plugin.host.GetMounter())
}

func (plugin *glusterfsPlugin) newUnmounterInternal(volName string, podUID types.UID, mounter mount.Interface) (volumeshadow.Unmounter, error) {
...
func (plugin *glusterfsPlugin) ConstructVolumeSpec(volumeName, mountPath string) (*volumeshadow.Spec, error) {
	...
	return volumeshadow.NewSpecFromVolume(glusterfsVolume), nil
}
...
var _ volumeshadow.Mounter = &glusterfsMounter{}

func (b *glusterfsMounter) GetAttributes() volumeshadow.Attributes {
...
var _ volumeshadow.Unmounter = &glusterfsUnmounter{}
...
func getVolumeSource(
	spec *volumeshadow.Spec) (*v1.GlusterfsVolumeSource, bool, error) {
	if spec.Volume != nil && spec.Volume.Glusterfs != nil {
...
func (plugin *glusterfsPlugin) NewProvisioner(options volumeshadow.VolumeOptions) (volumeshadow.Provisioner, error) {
...
func (plugin *glusterfsPlugin) newProvisionerInternal(options volumeshadow.VolumeOptions) (volumeshadow.Provisioner, error) {
...
func (plugin *glusterfsPlugin) NewDeleter(spec *volumeshadow.Spec) (volumeshadow.Deleter, error) {
	return plugin.newDeleterInternal(spec)
}

func (plugin *glusterfsPlugin) newDeleterInternal(spec *volumeshadow.Spec) (volumeshadow.Deleter, error) {
	if spec.PersistentVolume != nil && spec.PersistentVolume.Spec.Glusterfs == nil {
...
func (p *glusterfsVolumeProvisioner) CreateVolume() (r *v1.GlusterfsVolumeSource, size int, err error) {
	...
	sz := int(volumeshadow.RoundUpSize(volSizeBytes, 1024*1024*1024))
...
// annotations.
func (p *glusterfsVolumeProvisioner) paramToAnnotations(pv *v1.PersistentVolume) {
...
func (d *glusterfsVolumeDeleter) annotationsToParam(pv *v1.PersistentVolume) error {
	annKeys := []string{
