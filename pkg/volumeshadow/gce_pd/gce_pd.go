...
func ProbeVolumePlugins() []volumeshadow.VolumePlugin {
	return []volumeshadow.VolumePlugin{&gcePersistentDiskPlugin{nil}}
}
...
var _ volumeshadow.VolumePlugin = &gcePersistentDiskPlugin{}
var _ volumeshadow.PersistentVolumePlugin = &gcePersistentDiskPlugin{}
var _ volumeshadow.DeletableVolumePlugin = &gcePersistentDiskPlugin{}
var _ volumeshadow.ProvisionableVolumePlugin = &gcePersistentDiskPlugin{}
...
func (plugin *gcePersistentDiskPlugin) Init(host volumeshadow.VolumeHost) error {
	plugin.host = host
	return nil
}
...
func (plugin *gcePersistentDiskPlugin) GetVolumeName(spec *volumeshadow.Spec) (string, error) {
...
func (plugin *gcePersistentDiskPlugin) CanSupport(spec *volumeshadow.Spec) bool {
...
func (plugin *gcePersistentDiskPlugin) NewMounter(spec *volumeshadow.Spec, pod *v1.Pod, _ volumeshadow.VolumeOptions) (volumeshadow.Mounter, error) {
	// Inject real implementations here, test through the internal function.
	return plugin.newMounterInternal(spec, pod.UID, &GCEDiskUtil{}, plugin.host.GetMounter())
}

func getVolumeSource(
	spec *volumeshadow.Spec) (*v1.GCEPersistentDiskVolumeSource, bool, error) {
...
func (plugin *gcePersistentDiskPlugin) newMounterInternal(spec *volumeshadow.Spec, podUID types.UID, manager pdManager, mounter mount.Interface) (volumeshadow.Mounter, error) {
...
func (plugin *gcePersistentDiskPlugin) NewUnmounter(volName string, podUID types.UID) (volumeshadow.Unmounter, error) {
	// Inject real implementations here, test through the internal function.
	return plugin.newUnmounterInternal(volName, podUID, &GCEDiskUtil{}, plugin.host.GetMounter())
}

func (plugin *gcePersistentDiskPlugin) newUnmounterInternal(volName string, podUID types.UID, manager pdManager, mounter mount.Interface) (volumeshadow.Unmounter, error) {
...
func (plugin *gcePersistentDiskPlugin) NewDeleter(spec *volumeshadow.Spec) (volumeshadow.Deleter, error) {
	return plugin.newDeleterInternal(spec, &GCEDiskUtil{})
}

func (plugin *gcePersistentDiskPlugin) newDeleterInternal(spec *volumeshadow.Spec, manager pdManager) (volumeshadow.Deleter, error) {
...
func (plugin *gcePersistentDiskPlugin) NewProvisioner(options volumeshadow.VolumeOptions) (volumeshadow.Provisioner, error) {
...
func (plugin *gcePersistentDiskPlugin) newProvisionerInternal(options volumeshadow.VolumeOptions, manager pdManager) (volumeshadow.Provisioner, error) {
...
func (plugin *gcePersistentDiskPlugin) ConstructVolumeSpec(volumeName, mountPath string) (*volumeshadow.Spec, error) {
	...
	return volumeshadow.NewSpecFromVolume(gceVolume), nil
}
...
var _ volumeshadow.Mounter = &gcePersistentDiskMounter{}

func (b *gcePersistentDiskMounter) GetAttributes() volumeshadow.Attributes {
...
func makeGlobalPDName(host volumeshadow.VolumeHost, devName string) string {
...
var _ volumeshadow.Unmounter = &gcePersistentDiskUnmounter{}
...
var _ volumeshadow.Deleter = &gcePersistentDiskDeleter{}
...
var _ volumeshadow.Provisioner = &gcePersistentDiskProvisioner{}
