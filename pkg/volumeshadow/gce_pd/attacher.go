...
var _ volumeshadow.Attacher = &gcePersistentDiskAttacher{}

var _ volumeshadow.AttachableVolumePlugin = &gcePersistentDiskPlugin{}

func (plugin *gcePersistentDiskPlugin) NewAttacher() (volumeshadow.Attacher, error) {
...
// detach operations.
func (attacher *gcePersistentDiskAttacher) Attach(spec *volumeshadow.Spec, nodeName k8stypes.NodeName) (string, error) {
...
func (attacher *gcePersistentDiskAttacher) WaitForAttach(spec *volumeshadow.Spec, devicePath string, timeout time.Duration) (string, error) {
...
func (attacher *gcePersistentDiskAttacher) MountDevice(spec *volumeshadow.Spec, devicePath string, deviceMountPath string) error {
...
var _ volumeshadow.Detacher = &gcePersistentDiskDetacher{}

func (plugin *gcePersistentDiskPlugin) NewDetacher() (volumeshadow.Detacher, error) {
	gceCloud, err := getCloudProvider(plugin.host.GetCloudProvider())
	if err != nil {
		return nil, err
	}
...
// operations.
func (detacher *gcePersistentDiskDetacher) Detach(deviceMountPath string, nodeName k8stypes.NodeName) error {
