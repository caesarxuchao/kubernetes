...
func (testcase *testcase) AttachDisk(diskName string, nodeName k8stypes.NodeName, readOnly bool) error {
...
func (testcase *testcase) DetachDisk(devicePath string, nodeName k8stypes.NodeName) error {
