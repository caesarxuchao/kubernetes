...
func ProbeVolumePlugins() []volumeshadow.VolumePlugin {
	return []volumeshadow.VolumePlugin{&cephfsPlugin{nil}}
}
...
var _ volumeshadow.VolumePlugin = &cephfsPlugin{}

const (
	cephfsPluginName = "kubernetes.io/cephfs"
)

func (plugin *cephfsPlugin) Init(host volumeshadow.VolumeHost) error {
	plugin.host = host
	return nil
}
...
func (plugin *cephfsPlugin) GetVolumeName(spec *volumeshadow.Spec) (string, error) {
...
func (plugin *cephfsPlugin) CanSupport(spec *volumeshadow.Spec) bool {
...
func (plugin *cephfsPlugin) NewMounter(spec *volumeshadow.Spec, pod *v1.Pod, _ volumeshadow.VolumeOptions) (volumeshadow.Mounter, error) {
...
func (plugin *cephfsPlugin) newMounterInternal(spec *volumeshadow.Spec, podUID types.UID, mounter mount.Interface, secret string) (volumeshadow.Mounter, error) {
	cephvs, _, err := getVolumeSource(spec)
	if err != nil {
		return nil, err
	}
...
func (plugin *cephfsPlugin) NewUnmounter(volName string, podUID types.UID) (volumeshadow.Unmounter, error) {
	return plugin.newUnmounterInternal(volName, podUID, plugin.host.GetMounter())
}

func (plugin *cephfsPlugin) newUnmounterInternal(volName string, podUID types.UID, mounter mount.Interface) (volumeshadow.Unmounter, error) {
...
func (plugin *cephfsPlugin) ConstructVolumeSpec(volumeName, mountPath string) (*volumeshadow.Spec, error) {
	...
	return volumeshadow.NewSpecFromVolume(cephfsVolume), nil
}
...
var _ volumeshadow.Mounter = &cephfsMounter{}

func (cephfsVolume *cephfsMounter) GetAttributes() volumeshadow.Attributes {
...
var _ volumeshadow.Unmounter = &cephfsUnmounter{}
...
func getVolumeSource(spec *volumeshadow.Spec) (*v1.CephFSVolumeSource, bool, error) {
