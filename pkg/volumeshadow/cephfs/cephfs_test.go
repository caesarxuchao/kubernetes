...
func TestCanSupport(t *testing.T) {
	...
	if !plug.CanSupport(&volumeshadow.Spec{Volume: &v1.Volume{VolumeSource: v1.VolumeSource{CephFS: &v1.CephFSVolumeSource{}}}}) {
...
func TestPlugin(t *testing.T) {
	...
	mounter, err := plug.(*cephfsPlugin).newMounterInternal(volumeshadow.NewSpecFromVolume(spec), types.UID("poduid"), &mount.FakeMounter{}, "secrets")
