...
func newTestHost(t *testing.T) (string, volumeshadow.VolumeHost) {
...
func TestCanSupport(t *testing.T) {
	...
	if !plug.CanSupport(&volumeshadow.Spec{Volume: &v1.Volume{VolumeSource: v1.VolumeSource{GitRepo: &v1.GitRepoVolumeSource{}}}}) {
...
func doTestPlugin(scenario struct {
	...
	mounter, err := plug.NewMounter(volumeshadow.NewSpecFromVolume(scenario.vol), pod, volumeshadow.VolumeOptions{})
...
func doTestSetUp(scenario struct {
	...
	expecteds         []expectedCommand
	isExpectedFailure bool
}, mounter volumeshadow.Mounter) []error {
