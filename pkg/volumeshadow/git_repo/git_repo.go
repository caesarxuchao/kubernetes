...
func ProbeVolumePlugins() []volumeshadow.VolumePlugin {
	return []volumeshadow.VolumePlugin{&gitRepoPlugin{nil}}
}
...
var _ volumeshadow.VolumePlugin = &gitRepoPlugin{}
...
func (plugin *gitRepoPlugin) Init(host volumeshadow.VolumeHost) error {
	plugin.host = host
	return nil
}
...
func (plugin *gitRepoPlugin) GetVolumeName(spec *volumeshadow.Spec) (string, error) {
...
func (plugin *gitRepoPlugin) CanSupport(spec *volumeshadow.Spec) bool {
...
func (plugin *gitRepoPlugin) NewMounter(spec *volumeshadow.Spec, pod *v1.Pod, opts volumeshadow.VolumeOptions) (volumeshadow.Mounter, error) {
...
func (plugin *gitRepoPlugin) NewUnmounter(volName string, podUID types.UID) (volumeshadow.Unmounter, error) {
...
func (plugin *gitRepoPlugin) ConstructVolumeSpec(volumeName, mountPath string) (*volumeshadow.Spec, error) {
	gitVolume := &v1.Volume{
		Name: volumeName,
	...
	return volumeshadow.NewSpecFromVolume(gitVolume), nil
}
...
var _ volumeshadow.Volume = &gitRepoVolume{}
...
var _ volumeshadow.Mounter = &gitRepoVolumeMounter{}

func (b *gitRepoVolumeMounter) GetAttributes() volumeshadow.Attributes {
...
var _ volumeshadow.Unmounter = &gitRepoVolumeUnmounter{}
...
func getVolumeSource(spec *volumeshadow.Spec) (*v1.GitRepoVolumeSource, bool) {
	var readOnly bool
