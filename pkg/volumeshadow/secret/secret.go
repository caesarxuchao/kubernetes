...
func ProbeVolumePlugins() []volumeshadow.VolumePlugin {
	return []volumeshadow.VolumePlugin{&secretPlugin{}}
}
...
var _ volumeshadow.VolumePlugin = &secretPlugin{}
...
func (plugin *secretPlugin) Init(host volumeshadow.VolumeHost) error {
	plugin.host = host
	return nil
}
...
func (plugin *secretPlugin) GetVolumeName(spec *volumeshadow.Spec) (string, error) {
...
func (plugin *secretPlugin) CanSupport(spec *volumeshadow.Spec) bool {
...
func (plugin *secretPlugin) NewMounter(spec *volumeshadow.Spec, pod *v1.Pod, opts volumeshadow.VolumeOptions) (volumeshadow.Mounter, error) {
	return &secretVolumeMounter{
		secretVolume: &secretVolume{
			...
			volumeshadow.NewCachedMetrics(volumeshadow.NewMetricsDu(getPath(pod.UID, spec.Name(), plugin.host))),
		},
...
func (plugin *secretPlugin) NewUnmounter(volName string, podUID types.UID) (volumeshadow.Unmounter, error) {
	return &secretVolumeUnmounter{
		&secretVolume{
			...
			plugin.host.GetMounter(),
			plugin.host.GetWriter(),
			volumeshadow.NewCachedMetrics(volumeshadow.NewMetricsDu(getPath(podUID, volName, plugin.host))),
		},
	}, nil
}

func (plugin *secretPlugin) ConstructVolumeSpec(volName, mountPath string) (*volumeshadow.Spec, error) {
	...
	return volumeshadow.NewSpecFromVolume(secretVolume), nil
}
...
var _ volumeshadow.Volume = &secretVolume{}
...
var _ volumeshadow.Mounter = &secretVolumeMounter{}

func (sv *secretVolume) GetAttributes() volumeshadow.Attributes {
...
var _ volumeshadow.Unmounter = &secretVolumeUnmounter{}
...
func getVolumeSource(spec *volumeshadow.Spec) (*v1.SecretVolumeSource, bool) {
	var readOnly bool
