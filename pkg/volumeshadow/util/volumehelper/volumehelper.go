...
import (
	...
	"k8s.io/kubernetes/pkg/volumeshadow/util/types"
)
...
func GetUniqueVolumeNameForNonAttachableVolume(
	podName types.UniquePodName, volumePlugin volumeshadow.VolumePlugin, volumeSpec *volumeshadow.Spec) v1.UniqueVolumeName {
...
func GetUniqueVolumeNameFromSpec(
	volumePlugin volumeshadow.VolumePlugin,
	volumeSpec *volumeshadow.Spec) (v1.UniqueVolumeName, error) {
	if volumePlugin == nil {
		return "", fmt.Errorf(
