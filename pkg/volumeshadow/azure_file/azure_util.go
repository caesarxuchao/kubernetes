...
type azureUtil interface {
	GetAzureCredentials(host volumeshadow.VolumeHost, nameSpace, secretName, shareName string) (string, string, error)
}

type azureSvc struct{}

func (s *azureSvc) GetAzureCredentials(host volumeshadow.VolumeHost, nameSpace, secretName, shareName string) (string, string, error) {
