...
func ProbeVolumePlugins() []volumeshadow.VolumePlugin {
	return []volumeshadow.VolumePlugin{&azureFilePlugin{nil}}
}
...
var _ volumeshadow.VolumePlugin = &azureFilePlugin{}
var _ volumeshadow.PersistentVolumePlugin = &azureFilePlugin{}
...
func (plugin *azureFilePlugin) Init(host volumeshadow.VolumeHost) error {
	plugin.host = host
	return nil
}
...
func (plugin *azureFilePlugin) GetVolumeName(spec *volumeshadow.Spec) (string, error) {
...
func (plugin *azureFilePlugin) CanSupport(spec *volumeshadow.Spec) bool {
...
func (plugin *azureFilePlugin) NewMounter(spec *volumeshadow.Spec, pod *v1.Pod, _ volumeshadow.VolumeOptions) (volumeshadow.Mounter, error) {
	return plugin.newMounterInternal(spec, pod, &azureSvc{}, plugin.host.GetMounter())
}

func (plugin *azureFilePlugin) newMounterInternal(spec *volumeshadow.Spec, pod *v1.Pod, util azureUtil, mounter mount.Interface) (volumeshadow.Mounter, error) {
	...
	return &azureFileMounter{
		azureFile: &azureFile{
			...
			pod:             pod,
			plugin:          plugin,
			MetricsProvider: volumeshadow.NewMetricsStatFS(getPath(pod.UID, spec.Name(), plugin.host)),
		},
		util:       util,
...
func (plugin *azureFilePlugin) NewUnmounter(volName string, podUID types.UID) (volumeshadow.Unmounter, error) {
	return plugin.newUnmounterInternal(volName, podUID, plugin.host.GetMounter())
}

func (plugin *azureFilePlugin) newUnmounterInternal(volName string, podUID types.UID, mounter mount.Interface) (volumeshadow.Unmounter, error) {
...
func (plugin *azureFilePlugin) ConstructVolumeSpec(volName, mountPath string) (*volumeshadow.Spec, error) {
	...
	return volumeshadow.NewSpecFromVolume(azureVolume), nil
}
...
var _ volumeshadow.Mounter = &azureFileMounter{}

func (b *azureFileMounter) GetAttributes() volumeshadow.Attributes {
...
var _ volumeshadow.Unmounter = &azureFileUnmounter{}
...
func getVolumeSource(
	spec *volumeshadow.Spec) (*v1.AzureFileVolumeSource, bool, error) {
