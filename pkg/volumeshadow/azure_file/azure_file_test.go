...
func TestCanSupport(t *testing.T) {
	...
	if !plug.CanSupport(&volumeshadow.Spec{Volume: &v1.Volume{VolumeSource: v1.VolumeSource{AzureFile: &v1.AzureFileVolumeSource{}}}}) {
		t.Errorf("Expected true")
	}
	if !plug.CanSupport(&volumeshadow.Spec{PersistentVolume: &v1.PersistentVolume{Spec: v1.PersistentVolumeSpec{PersistentVolumeSource: v1.PersistentVolumeSource{AzureFile: &v1.AzureFileVolumeSource{}}}}}) {
		t.Errorf("Expected true")
	}
}
...
func TestPlugin(t *testing.T) {
	...
	mounter, err := plug.(*azureFilePlugin).newMounterInternal(volumeshadow.NewSpecFromVolume(spec), pod, &fakeAzureSvc{}, fake)
	if err != nil {
...
func (s *fakeAzureSvc) GetAzureCredentials(host volumeshadow.VolumeHost, nameSpace, secretName, shareName string) (string, string, error) {
	return "name", "key", nil
}
