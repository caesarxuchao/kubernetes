...
func TestAttachDetach(t *testing.T) {
	diskName := "disk"
	instanceID := "instance"
	nodeName := k8stypes.NodeName(instanceID)
	readOnly := false
...
func createVolSpec(name string, readOnly bool) *volumeshadow.Spec {
...
func createPVSpec(name string, readOnly bool) *volumeshadow.Spec {
	return &volumeshadow.Spec{
...
func (instances *instances) NodeAddresses(name k8stypes.NodeName) ([]v1.NodeAddress, error) {
	return []v1.NodeAddress{}, errors.New("Not implemented")
}

func (instances *instances) ExternalID(name k8stypes.NodeName) (string, error) {
	return "", errors.New("Not implemented")
}

func (instances *instances) InstanceID(name k8stypes.NodeName) (string, error) {
	return instances.instanceID, nil
}

func (instances *instances) InstanceType(name k8stypes.NodeName) (string, error) {
	return "", errors.New("Not implemented")
}

func (instances *instances) List(filter string) ([]k8stypes.NodeName, error) {
	return []k8stypes.NodeName{}, errors.New("Not implemented")
}
...
func (instances *instances) CurrentNodeName(hostname string) (k8stypes.NodeName, error) {
	return "", errors.New("Not implemented")
}
