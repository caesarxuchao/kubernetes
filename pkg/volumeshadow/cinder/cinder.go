...
func ProbeVolumePlugins() []volumeshadow.VolumePlugin {
	return []volumeshadow.VolumePlugin{&cinderPlugin{}}
}
...
var _ volumeshadow.VolumePlugin = &cinderPlugin{}
var _ volumeshadow.PersistentVolumePlugin = &cinderPlugin{}
var _ volumeshadow.DeletableVolumePlugin = &cinderPlugin{}
var _ volumeshadow.ProvisionableVolumePlugin = &cinderPlugin{}

const (
	cinderVolumePluginName = "kubernetes.io/cinder"
)

func (plugin *cinderPlugin) Init(host volumeshadow.VolumeHost) error {
	plugin.host = host
...
func (plugin *cinderPlugin) GetVolumeName(spec *volumeshadow.Spec) (string, error) {
...
func (plugin *cinderPlugin) CanSupport(spec *volumeshadow.Spec) bool {
...
func (plugin *cinderPlugin) NewMounter(spec *volumeshadow.Spec, pod *v1.Pod, _ volumeshadow.VolumeOptions) (volumeshadow.Mounter, error) {
	return plugin.newMounterInternal(spec, pod.UID, &CinderDiskUtil{}, plugin.host.GetMounter())
}

func (plugin *cinderPlugin) newMounterInternal(spec *volumeshadow.Spec, podUID types.UID, manager cdManager, mounter mount.Interface) (volumeshadow.Mounter, error) {
...
func (plugin *cinderPlugin) NewUnmounter(volName string, podUID types.UID) (volumeshadow.Unmounter, error) {
	return plugin.newUnmounterInternal(volName, podUID, &CinderDiskUtil{}, plugin.host.GetMounter())
}

func (plugin *cinderPlugin) newUnmounterInternal(volName string, podUID types.UID, manager cdManager, mounter mount.Interface) (volumeshadow.Unmounter, error) {
...
func (plugin *cinderPlugin) NewDeleter(spec *volumeshadow.Spec) (volumeshadow.Deleter, error) {
	return plugin.newDeleterInternal(spec, &CinderDiskUtil{})
}

func (plugin *cinderPlugin) newDeleterInternal(spec *volumeshadow.Spec, manager cdManager) (volumeshadow.Deleter, error) {
...
func (plugin *cinderPlugin) NewProvisioner(options volumeshadow.VolumeOptions) (volumeshadow.Provisioner, error) {
...
func (plugin *cinderPlugin) newProvisionerInternal(options volumeshadow.VolumeOptions, manager cdManager) (volumeshadow.Provisioner, error) {
...
func (plugin *cinderPlugin) ConstructVolumeSpec(volumeName, mountPath string) (*volumeshadow.Spec, error) {
	...
	return volumeshadow.NewSpecFromVolume(cinderVolume), nil
}
...
var _ volumeshadow.Mounter = &cinderVolumeMounter{}
...
func (b *cinderVolumeMounter) GetAttributes() volumeshadow.Attributes {
...
var _ volumeshadow.Unmounter = &cinderVolumeUnmounter{}
...
var _ volumeshadow.Deleter = &cinderVolumeDeleter{}
...
var _ volumeshadow.Provisioner = &cinderVolumeProvisioner{}
...
func getVolumeSource(spec *volumeshadow.Spec) (*v1.CinderVolumeSource, bool, error) {
