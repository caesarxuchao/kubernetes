...
func convert_api_Status_To_v1alpha1_Status(in *api.Status, out *Status, s conversion.Scope) error {
	if defaulting, found := s.DefaultingInterface(reflect.TypeOf(*in)); found {
	...
	if in.Details != nil {
		...
		if err := convert_api_StatusDetails_To_v1alpha1_StatusDetails(in.Details, out.Details, s); err != nil {
			return err
		}
	} else {
		out.Details = nil
...
func convert_api_StatusCause_To_v1alpha1_StatusCause(in *api.StatusCause, out *StatusCause, s conversion.Scope) error {
	if defaulting, found := s.DefaultingInterface(reflect.TypeOf(*in)); found {
...
func convert_api_StatusDetails_To_v1alpha1_StatusDetails(in *api.StatusDetails, out *StatusDetails, s conversion.Scope) error {
	if defaulting, found := s.DefaultingInterface(reflect.TypeOf(*in)); found {
	...
	if in.Causes != nil {
		...
		for i := range in.Causes {
			if err := convert_api_StatusCause_To_v1alpha1_StatusCause(&in.Causes[i], &out.Causes[i], s); err != nil {
				return err
			}
		}
	} else {
...
func convert_expapi_APIVersion_To_v1alpha1_APIVersion(in *expapi.APIVersion, out *APIVersion, s conversion.Scope) error {
	if defaulting, found := s.DefaultingInterface(reflect.TypeOf(*in)); found {
...
func convert_expapi_Daemon_To_v1alpha1_Daemon(in *expapi.Daemon, out *Daemon, s conversion.Scope) error {
	if defaulting, found := s.DefaultingInterface(reflect.TypeOf(*in)); found {
	...
	if err := convert_expapi_DaemonSpec_To_v1alpha1_DaemonSpec(&in.Spec, &out.Spec, s); err != nil {
		return err
	}
	if err := convert_expapi_DaemonStatus_To_v1alpha1_DaemonStatus(&in.Status, &out.Status, s); err != nil {
		return err
	}
	return nil
}

func convert_expapi_DaemonList_To_v1alpha1_DaemonList(in *expapi.DaemonList, out *DaemonList, s conversion.Scope) error {
	if defaulting, found := s.DefaultingInterface(reflect.TypeOf(*in)); found {
	...
	if in.Items != nil {
		...
		for i := range in.Items {
			if err := convert_expapi_Daemon_To_v1alpha1_Daemon(&in.Items[i], &out.Items[i], s); err != nil {
				return err
			}
		}
	} else {
...
func convert_expapi_DaemonSpec_To_v1alpha1_DaemonSpec(in *expapi.DaemonSpec, out *DaemonSpec, s conversion.Scope) error {
	if defaulting, found := s.DefaultingInterface(reflect.TypeOf(*in)); found {
...
func convert_expapi_DaemonStatus_To_v1alpha1_DaemonStatus(in *expapi.DaemonStatus, out *DaemonStatus, s conversion.Scope) error {
	if defaulting, found := s.DefaultingInterface(reflect.TypeOf(*in)); found {
...
func convert_expapi_Deployment_To_v1alpha1_Deployment(in *expapi.Deployment, out *Deployment, s conversion.Scope) error {
	if defaulting, found := s.DefaultingInterface(reflect.TypeOf(*in)); found {
	...
	if err := convert_expapi_DeploymentSpec_To_v1alpha1_DeploymentSpec(&in.Spec, &out.Spec, s); err != nil {
		return err
	}
	if err := convert_expapi_DeploymentStatus_To_v1alpha1_DeploymentStatus(&in.Status, &out.Status, s); err != nil {
		return err
	}
	return nil
}

func convert_expapi_DeploymentList_To_v1alpha1_DeploymentList(in *expapi.DeploymentList, out *DeploymentList, s conversion.Scope) error {
	if defaulting, found := s.DefaultingInterface(reflect.TypeOf(*in)); found {
	...
	if in.Items != nil {
		...
		for i := range in.Items {
			if err := convert_expapi_Deployment_To_v1alpha1_Deployment(&in.Items[i], &out.Items[i], s); err != nil {
				return err
			}
		}
	} else {
...
func convert_expapi_DeploymentStatus_To_v1alpha1_DeploymentStatus(in *expapi.DeploymentStatus, out *DeploymentStatus, s conversion.Scope) error {
	if defaulting, found := s.DefaultingInterface(reflect.TypeOf(*in)); found {
...
func convert_expapi_HorizontalPodAutoscaler_To_v1alpha1_HorizontalPodAutoscaler(in *expapi.HorizontalPodAutoscaler, out *HorizontalPodAutoscaler, s conversion.Scope) error {
	...
	if err := convert_expapi_HorizontalPodAutoscalerSpec_To_v1alpha1_HorizontalPodAutoscalerSpec(&in.Spec, &out.Spec, s); err != nil {
		return err
	}
	if in.Status != nil {
		out.Status = new(HorizontalPodAutoscalerStatus)
		if err := convert_expapi_HorizontalPodAutoscalerStatus_To_v1alpha1_HorizontalPodAutoscalerStatus(in.Status, out.Status, s); err != nil {
			return err
		}
	} else {
		out.Status = nil
...
func convert_expapi_HorizontalPodAutoscalerList_To_v1alpha1_HorizontalPodAutoscalerList(in *expapi.HorizontalPodAutoscalerList, out *HorizontalPodAutoscalerList, s conversion.Scope) error {
	if defaulting, found := s.DefaultingInterface(reflect.TypeOf(*in)); found {
	...
	if in.Items != nil {
		...
		for i := range in.Items {
			if err := convert_expapi_HorizontalPodAutoscaler_To_v1alpha1_HorizontalPodAutoscaler(&in.Items[i], &out.Items[i], s); err != nil {
				return err
			}
		}
	} else {
...
func convert_expapi_HorizontalPodAutoscalerSpec_To_v1alpha1_HorizontalPodAutoscalerSpec(in *expapi.HorizontalPodAutoscalerSpec, out *HorizontalPodAutoscalerSpec, s conversion.Scope) error {
	if defaulting, found := s.DefaultingInterface(reflect.TypeOf(*in)); found {
		defaulting.(func(*expapi.HorizontalPodAutoscalerSpec))(in)
	}
	if in.ScaleRef != nil {
		out.ScaleRef = new(SubresourceReference)
		if err := convert_expapi_SubresourceReference_To_v1alpha1_SubresourceReference(in.ScaleRef, out.ScaleRef, s); err != nil {
			return err
		}
	} else {
		out.ScaleRef = nil
	...
	if err := convert_expapi_ResourceConsumption_To_v1alpha1_ResourceConsumption(&in.Target, &out.Target, s); err != nil {
		return err
	}
	return nil
}

func convert_expapi_HorizontalPodAutoscalerStatus_To_v1alpha1_HorizontalPodAutoscalerStatus(in *expapi.HorizontalPodAutoscalerStatus, out *HorizontalPodAutoscalerStatus, s conversion.Scope) error {
	if defaulting, found := s.DefaultingInterface(reflect.TypeOf(*in)); found {
	...
	if in.CurrentConsumption != nil {
		...
		if err := convert_expapi_ResourceConsumption_To_v1alpha1_ResourceConsumption(in.CurrentConsumption, out.CurrentConsumption, s); err != nil {
			return err
		}
	} else {
...
func convert_expapi_ReplicationControllerDummy_To_v1alpha1_ReplicationControllerDummy(in *expapi.ReplicationControllerDummy, out *ReplicationControllerDummy, s conversion.Scope) error {
	if defaulting, found := s.DefaultingInterface(reflect.TypeOf(*in)); found {
...
func convert_expapi_ResourceConsumption_To_v1alpha1_ResourceConsumption(in *expapi.ResourceConsumption, out *ResourceConsumption, s conversion.Scope) error {
	if defaulting, found := s.DefaultingInterface(reflect.TypeOf(*in)); found {
...
func convert_expapi_Scale_To_v1alpha1_Scale(in *expapi.Scale, out *Scale, s conversion.Scope) error {
	...
	if err := convert_expapi_ScaleSpec_To_v1alpha1_ScaleSpec(&in.Spec, &out.Spec, s); err != nil {
		return err
	}
	if err := convert_expapi_ScaleStatus_To_v1alpha1_ScaleStatus(&in.Status, &out.Status, s); err != nil {
		return err
	}
	return nil
}

func convert_expapi_ScaleSpec_To_v1alpha1_ScaleSpec(in *expapi.ScaleSpec, out *ScaleSpec, s conversion.Scope) error {
	if defaulting, found := s.DefaultingInterface(reflect.TypeOf(*in)); found {
...
func convert_expapi_ScaleStatus_To_v1alpha1_ScaleStatus(in *expapi.ScaleStatus, out *ScaleStatus, s conversion.Scope) error {
	if defaulting, found := s.DefaultingInterface(reflect.TypeOf(*in)); found {
...
func convert_expapi_SubresourceReference_To_v1alpha1_SubresourceReference(in *expapi.SubresourceReference, out *SubresourceReference, s conversion.Scope) error {
	if defaulting, found := s.DefaultingInterface(reflect.TypeOf(*in)); found {
...
func convert_expapi_ThirdPartyResource_To_v1alpha1_ThirdPartyResource(in *expapi.ThirdPartyResource, out *ThirdPartyResource, s conversion.Scope) error {
	if defaulting, found := s.DefaultingInterface(reflect.TypeOf(*in)); found {
	...
	if in.Versions != nil {
		...
		for i := range in.Versions {
			if err := convert_expapi_APIVersion_To_v1alpha1_APIVersion(&in.Versions[i], &out.Versions[i], s); err != nil {
				return err
			}
		}
	} else {
...
func convert_expapi_ThirdPartyResourceList_To_v1alpha1_ThirdPartyResourceList(in *expapi.ThirdPartyResourceList, out *ThirdPartyResourceList, s conversion.Scope) error {
	if defaulting, found := s.DefaultingInterface(reflect.TypeOf(*in)); found {
	...
	if in.Items != nil {
		...
		for i := range in.Items {
			if err := convert_expapi_ThirdPartyResource_To_v1alpha1_ThirdPartyResource(&in.Items[i], &out.Items[i], s); err != nil {
				return err
			}
		}
	} else {
...
func convert_v1alpha1_APIVersion_To_expapi_APIVersion(in *APIVersion, out *expapi.APIVersion, s conversion.Scope) error {
	if defaulting, found := s.DefaultingInterface(reflect.TypeOf(*in)); found {
...
func convert_v1alpha1_Daemon_To_expapi_Daemon(in *Daemon, out *expapi.Daemon, s conversion.Scope) error {
	if defaulting, found := s.DefaultingInterface(reflect.TypeOf(*in)); found {
	...
	if err := convert_v1alpha1_DaemonSpec_To_expapi_DaemonSpec(&in.Spec, &out.Spec, s); err != nil {
		return err
	}
	if err := convert_v1alpha1_DaemonStatus_To_expapi_DaemonStatus(&in.Status, &out.Status, s); err != nil {
		return err
	}
	return nil
}

func convert_v1alpha1_DaemonList_To_expapi_DaemonList(in *DaemonList, out *expapi.DaemonList, s conversion.Scope) error {
	if defaulting, found := s.DefaultingInterface(reflect.TypeOf(*in)); found {
	...
	if in.Items != nil {
		...
		for i := range in.Items {
			if err := convert_v1alpha1_Daemon_To_expapi_Daemon(&in.Items[i], &out.Items[i], s); err != nil {
				return err
			}
		}
	} else {
...
func convert_v1alpha1_DaemonSpec_To_expapi_DaemonSpec(in *DaemonSpec, out *expapi.DaemonSpec, s conversion.Scope) error {
	if defaulting, found := s.DefaultingInterface(reflect.TypeOf(*in)); found {
...
func convert_v1alpha1_DaemonStatus_To_expapi_DaemonStatus(in *DaemonStatus, out *expapi.DaemonStatus, s conversion.Scope) error {
	if defaulting, found := s.DefaultingInterface(reflect.TypeOf(*in)); found {
...
func convert_v1alpha1_Deployment_To_expapi_Deployment(in *Deployment, out *expapi.Deployment, s conversion.Scope) error {
	if defaulting, found := s.DefaultingInterface(reflect.TypeOf(*in)); found {
	...
	if err := convert_v1alpha1_DeploymentSpec_To_expapi_DeploymentSpec(&in.Spec, &out.Spec, s); err != nil {
		return err
	}
	if err := convert_v1alpha1_DeploymentStatus_To_expapi_DeploymentStatus(&in.Status, &out.Status, s); err != nil {
		return err
	}
	return nil
}

func convert_v1alpha1_DeploymentList_To_expapi_DeploymentList(in *DeploymentList, out *expapi.DeploymentList, s conversion.Scope) error {
	if defaulting, found := s.DefaultingInterface(reflect.TypeOf(*in)); found {
	...
	if in.Items != nil {
		...
		for i := range in.Items {
			if err := convert_v1alpha1_Deployment_To_expapi_Deployment(&in.Items[i], &out.Items[i], s); err != nil {
				return err
			}
		}
	} else {
...
func convert_v1alpha1_DeploymentStatus_To_expapi_DeploymentStatus(in *DeploymentStatus, out *expapi.DeploymentStatus, s conversion.Scope) error {
	if defaulting, found := s.DefaultingInterface(reflect.TypeOf(*in)); found {
...
func convert_v1alpha1_HorizontalPodAutoscaler_To_expapi_HorizontalPodAutoscaler(in *HorizontalPodAutoscaler, out *expapi.HorizontalPodAutoscaler, s conversion.Scope) error {
	if defaulting, found := s.DefaultingInterface(reflect.TypeOf(*in)); found {
	...
	if err := convert_v1alpha1_HorizontalPodAutoscalerSpec_To_expapi_HorizontalPodAutoscalerSpec(&in.Spec, &out.Spec, s); err != nil {
		return err
	}
	if in.Status != nil {
		out.Status = new(expapi.HorizontalPodAutoscalerStatus)
		if err := convert_v1alpha1_HorizontalPodAutoscalerStatus_To_expapi_HorizontalPodAutoscalerStatus(in.Status, out.Status, s); err != nil {
			return err
		}
	} else {
		out.Status = nil
...
func convert_v1alpha1_HorizontalPodAutoscalerList_To_expapi_HorizontalPodAutoscalerList(in *HorizontalPodAutoscalerList, out *expapi.HorizontalPodAutoscalerList, s conversion.Scope) error {
	if defaulting, found := s.DefaultingInterface(reflect.TypeOf(*in)); found {
	...
	if in.Items != nil {
		...
		for i := range in.Items {
			if err := convert_v1alpha1_HorizontalPodAutoscaler_To_expapi_HorizontalPodAutoscaler(&in.Items[i], &out.Items[i], s); err != nil {
				return err
			}
		}
	} else {
...
func convert_v1alpha1_HorizontalPodAutoscalerSpec_To_expapi_HorizontalPodAutoscalerSpec(in *HorizontalPodAutoscalerSpec, out *expapi.HorizontalPodAutoscalerSpec, s conversion.Scope) error {
	if defaulting, found := s.DefaultingInterface(reflect.TypeOf(*in)); found {
		defaulting.(func(*HorizontalPodAutoscalerSpec))(in)
	}
	if in.ScaleRef != nil {
		out.ScaleRef = new(expapi.SubresourceReference)
		if err := convert_v1alpha1_SubresourceReference_To_expapi_SubresourceReference(in.ScaleRef, out.ScaleRef, s); err != nil {
			return err
		}
	} else {
		out.ScaleRef = nil
	...
	out.MinCount = in.MinCount
	out.MaxCount = in.MaxCount
	if err := convert_v1alpha1_ResourceConsumption_To_expapi_ResourceConsumption(&in.Target, &out.Target, s); err != nil {
		return err
	}
	return nil
}

func convert_v1alpha1_HorizontalPodAutoscalerStatus_To_expapi_HorizontalPodAutoscalerStatus(in *HorizontalPodAutoscalerStatus, out *expapi.HorizontalPodAutoscalerStatus, s conversion.Scope) error {
	if defaulting, found := s.DefaultingInterface(reflect.TypeOf(*in)); found {
	...
	if in.CurrentConsumption != nil {
		...
		if err := convert_v1alpha1_ResourceConsumption_To_expapi_ResourceConsumption(in.CurrentConsumption, out.CurrentConsumption, s); err != nil {
			return err
		}
	} else {
		out.CurrentConsumption = nil
...
func convert_v1alpha1_ReplicationControllerDummy_To_expapi_ReplicationControllerDummy(in *ReplicationControllerDummy, out *expapi.ReplicationControllerDummy, s conversion.Scope) error {
	if defaulting, found := s.DefaultingInterface(reflect.TypeOf(*in)); found {
...
func convert_v1alpha1_ResourceConsumption_To_expapi_ResourceConsumption(in *ResourceConsumption, out *expapi.ResourceConsumption, s conversion.Scope) error {
	if defaulting, found := s.DefaultingInterface(reflect.TypeOf(*in)); found {
...
func convert_v1alpha1_Scale_To_expapi_Scale(in *Scale, out *expapi.Scale, s conversion.Scope) error {
	...
	if err := convert_v1alpha1_ScaleSpec_To_expapi_ScaleSpec(&in.Spec, &out.Spec, s); err != nil {
		return err
	}
	if err := convert_v1alpha1_ScaleStatus_To_expapi_ScaleStatus(&in.Status, &out.Status, s); err != nil {
		return err
	}
	return nil
}

func convert_v1alpha1_ScaleSpec_To_expapi_ScaleSpec(in *ScaleSpec, out *expapi.ScaleSpec, s conversion.Scope) error {
	if defaulting, found := s.DefaultingInterface(reflect.TypeOf(*in)); found {
...
func convert_v1alpha1_ScaleStatus_To_expapi_ScaleStatus(in *ScaleStatus, out *expapi.ScaleStatus, s conversion.Scope) error {
	if defaulting, found := s.DefaultingInterface(reflect.TypeOf(*in)); found {
...
func convert_v1alpha1_Status_To_api_Status(in *Status, out *api.Status, s conversion.Scope) error {
	if defaulting, found := s.DefaultingInterface(reflect.TypeOf(*in)); found {
	...
	if in.Details != nil {
		...
		if err := convert_v1alpha1_StatusDetails_To_api_StatusDetails(in.Details, out.Details, s); err != nil {
			return err
		}
	} else {
		out.Details = nil
...
func convert_v1alpha1_StatusCause_To_api_StatusCause(in *StatusCause, out *api.StatusCause, s conversion.Scope) error {
	if defaulting, found := s.DefaultingInterface(reflect.TypeOf(*in)); found {
...
func convert_v1alpha1_StatusDetails_To_api_StatusDetails(in *StatusDetails, out *api.StatusDetails, s conversion.Scope) error {
	if defaulting, found := s.DefaultingInterface(reflect.TypeOf(*in)); found {
	...
	if in.Causes != nil {
		...
		for i := range in.Causes {
			if err := convert_v1alpha1_StatusCause_To_api_StatusCause(&in.Causes[i], &out.Causes[i], s); err != nil {
				return err
			}
		}
	} else {
...
func convert_v1alpha1_SubresourceReference_To_expapi_SubresourceReference(in *SubresourceReference, out *expapi.SubresourceReference, s conversion.Scope) error {
	if defaulting, found := s.DefaultingInterface(reflect.TypeOf(*in)); found {
...
func convert_v1alpha1_ThirdPartyResource_To_expapi_ThirdPartyResource(in *ThirdPartyResource, out *expapi.ThirdPartyResource, s conversion.Scope) error {
	if defaulting, found := s.DefaultingInterface(reflect.TypeOf(*in)); found {
	...
	if in.Versions != nil {
		...
		for i := range in.Versions {
			if err := convert_v1alpha1_APIVersion_To_expapi_APIVersion(&in.Versions[i], &out.Versions[i], s); err != nil {
				return err
			}
		}
	} else {
...
func convert_v1alpha1_ThirdPartyResourceList_To_expapi_ThirdPartyResourceList(in *ThirdPartyResourceList, out *expapi.ThirdPartyResourceList, s conversion.Scope) error {
	...
	if in.Items != nil {
		...
		for i := range in.Items {
			if err := convert_v1alpha1_ThirdPartyResource_To_expapi_ThirdPartyResource(&in.Items[i], &out.Items[i], s); err != nil {
				return err
			}
		}
	} else {
...
func init() {
	err := api.Scheme.AddGeneratedConversionFuncs(
		...
		convert_api_StatusCause_To_v1alpha1_StatusCause,
		convert_api_StatusDetails_To_v1alpha1_StatusDetails,
		convert_api_Status_To_v1alpha1_Status,
		...
		convert_expapi_APIVersion_To_v1alpha1_APIVersion,
		convert_expapi_DaemonList_To_v1alpha1_DaemonList,
		convert_expapi_DaemonSpec_To_v1alpha1_DaemonSpec,
		convert_expapi_DaemonStatus_To_v1alpha1_DaemonStatus,
		...
		convert_expapi_HorizontalPodAutoscalerStatus_To_v1alpha1_HorizontalPodAutoscalerStatus,
		...
		convert_v1alpha1_APIVersion_To_expapi_APIVersion,
		convert_v1alpha1_DaemonList_To_expapi_DaemonList,
		convert_v1alpha1_DaemonSpec_To_expapi_DaemonSpec,
		convert_v1alpha1_DaemonStatus_To_expapi_DaemonStatus,
		convert_v1alpha1_Daemon_To_expapi_Daemon,
		convert_v1alpha1_DeploymentList_To_expapi_DeploymentList,
		convert_v1alpha1_DeploymentStatus_To_expapi_DeploymentStatus,
		convert_v1alpha1_Deployment_To_expapi_Deployment,
		...
		convert_v1alpha1_HorizontalPodAutoscalerStatus_To_expapi_HorizontalPodAutoscalerStatus,
		...
		convert_v1alpha1_StatusCause_To_api_StatusCause,
		convert_v1alpha1_StatusDetails_To_api_StatusDetails,
		convert_v1alpha1_Status_To_api_Status,
