...
func autoConvert_apps_ControllerRevisionList_To_v1beta1_ControllerRevisionList(in *apps.ControllerRevisionList, out *appsv1beta1.ControllerRevisionList, s conversion.Scope) error {
	...
	if in.Items != nil {
		in, out := &in.Items, &out.Items
		*out = make([]appsv1beta1.ControllerRevision, len(*in))
		for i := range *in {
		...
		out.Items = make([]appsv1beta1.ControllerRevision, 0)
	}
	return nil
}
...
func autoConvert_v1beta1_PartitionStatefulSetStrategy_To_apps_PartitionStatefulSetStrategy(in *appsv1beta1.PartitionStatefulSetStrategy, out *apps.PartitionStatefulSetStrategy, s conversion.Scope) error {
...
func Convert_v1beta1_PartitionStatefulSetStrategy_To_apps_PartitionStatefulSetStrategy(in *appsv1beta1.PartitionStatefulSetStrategy, out *apps.PartitionStatefulSetStrategy, s conversion.Scope) error {
	return autoConvert_v1beta1_PartitionStatefulSetStrategy_To_apps_PartitionStatefulSetStrategy(in, out, s)
}

func autoConvert_apps_PartitionStatefulSetStrategy_To_v1beta1_PartitionStatefulSetStrategy(in *apps.PartitionStatefulSetStrategy, out *appsv1beta1.PartitionStatefulSetStrategy, s conversion.Scope) error {
	out.Ordinal = in.Ordinal
	return nil
}
...
func Convert_apps_PartitionStatefulSetStrategy_To_v1beta1_PartitionStatefulSetStrategy(in *apps.PartitionStatefulSetStrategy, out *appsv1beta1.PartitionStatefulSetStrategy, s conversion.Scope) error {
...
func autoConvert_apps_StatefulSetList_To_v1beta1_StatefulSetList(in *apps.StatefulSetList, out *appsv1beta1.StatefulSetList, s conversion.Scope) error {
	...
	if in.Items != nil {
		...
		*out = make([]appsv1beta1.StatefulSet, len(*in))
		...
		out.Items = make([]appsv1beta1.StatefulSet, 0)
	}
	return nil
}
...
func autoConvert_apps_StatefulSetUpdateStrategy_To_v1beta1_StatefulSetUpdateStrategy(in *apps.StatefulSetUpdateStrategy, out *appsv1beta1.StatefulSetUpdateStrategy, s conversion.Scope) error {
	...
	out.Partition = (*appsv1beta1.PartitionStatefulSetStrategy)(unsafe.Pointer(in.Partition))
	return nil
}
