...
var map_DeleteOptions = map[string]string{
	...
	"PropagationPolicy":  "Whether and how garbage collection will be performed. Defaults to DeletePropagationDefault. Either this field or OrphanDependents may be set, but not both.",
}
