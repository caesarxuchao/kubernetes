...
import (
	...
	unversionedautoscaling "k8s.io/client-go/1.5/kubernetes/typed/autoscaling/v1"
	v1core "k8s.io/client-go/1.5/kubernetes/typed/core/v1"
	unversionedextensions "k8s.io/client-go/1.5/kubernetes/typed/extensions/v1beta1"
...
func NewHorizontalController(evtNamespacer v1core.EventsGetter, scaleNamespacer unversionedextensions.ScalesGetter, hpaNamespacer unversionedautoscaling.HorizontalPodAutoscalersGetter, metricsClient metrics.MetricsClient, resyncPeriod time.Duration) *HorizontalController {
	...
	if scale.Spec.Replicas == 0 {
		...
		if hpa.Spec.TargetCPUUtilizationPercentage != nil || !cmAnnotationFound {
			...
			if err != nil {
				...
				a.eventRecorder.Event(hpa, v1.EventTypeWarning, "FailedComputeReplicas", err.Error())
		...
		if cmAnnotationFound {
			...
			if err != nil {
				a.updateCurrentReplicasInStatus(hpa, currentReplicas)
				a.eventRecorder.Event(hpa, v1.EventTypeWarning, "FailedComputeCMReplicas", err.Error())
