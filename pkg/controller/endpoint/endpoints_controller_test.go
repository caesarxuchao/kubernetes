...
func makeTestServer(t *testing.T, namespace string, endpointsResponse serverResponse) (*httptest.Server, *utiltesting.FakeHandler) {
	fakeEndpointsHandler := utiltesting.FakeHandler{
		...
		ResponseBody: runtime.EncodeOrDie(testv1.Default.Codec(), endpointsResponse.obj.(runtime.Object)),
	}
	mux := http.NewServeMux()
	mux.Handle(testv1.Default.ResourcePath("endpoints", namespace, ""), &fakeEndpointsHandler)
	mux.Handle(testv1.Default.ResourcePath("endpoints/", namespace, ""), &fakeEndpointsHandler)
...
func TestSyncEndpointsProtocolTCP(t *testing.T) {
	...
	data := runtime.EncodeOrDie(testv1.Default.Codec(), &v1.Endpoints{
		ObjectMeta: v1.ObjectMeta{
			Name:            "foo",
			Namespace:       ns,
			ResourceVersion: "1",
	...
	endpointsHandler.ValidateRequest(t, testv1.Default.ResourcePath("endpoints", ns, "foo"), "PUT", &data)
}
...
func TestSyncEndpointsItemsPreexistingIdentical(t *testing.T) {
	...
	endpoints.syncService(ns + "/foo")
	endpointsHandler.ValidateRequest(t, testv1.Default.ResourcePath("endpoints", v1.NamespaceDefault, "foo"), "GET", nil)
}
...
func TestSyncEndpointsItems(t *testing.T) {
	...
	endpointsHandler.ValidateRequestCount(t, 2)
	endpointsHandler.ValidateRequest(t, testv1.Default.ResourcePath("endpoints", ns, ""), "POST", &data)
}
