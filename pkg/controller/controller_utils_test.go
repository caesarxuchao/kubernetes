...
func TestCreatePods(t *testing.T) {
	...
	body := runtime.EncodeOrDie(testv1.Default.Codec(), &v1.Pod{ObjectMeta: v1.ObjectMeta{Name: "empty_pod"}})
	...
	fakeHandler.ValidateRequest(t, testv1.Default.ResourcePath("pods", v1.NamespaceDefault, ""), "POST", nil)
	actualPod, err := runtime.Decode(testv1.Default.Codec(), []byte(fakeHandler.RequestBody))
	if err != nil {
		t.Fatalf("Unexpected error: %v", err)
	}
