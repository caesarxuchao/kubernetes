	...
	tests := []controllerTest{
		...
		// PVC with class
		{
			...
			[]*v1.PersistentVolume{
				...
				newVolume("volume13-1-2", "10Gi", "", "", v1.VolumePending, v1.PersistentVolumeReclaimRetain, annClass),
			},
			[]*v1.PersistentVolume{
				newVolume("volume13-1-1", "1Gi", "", "", v1.VolumePending, v1.PersistentVolumeReclaimRetain),
				newVolume("volume13-1-2", "10Gi", "uid13-1", "claim13-1", v1.VolumeBound, v1.PersistentVolumeReclaimRetain, annBoundByController, annClass),
			},
			newClaimArray("claim13-1", "uid13-1", "1Gi", "", v1.ClaimPending, annClass),
			withExpectedCapacity("10Gi", newClaimArray("claim13-1", "uid13-1", "1Gi", "volume13-1-2", v1.ClaimBound, annBoundByController, annClass, annBindCompleted)),
			noevents, noerrors, testSyncClaim,
		},
		{
			...
			[]*v1.PersistentVolume{
				newVolume("volume13-2-1", "1Gi", "", "", v1.VolumePending, v1.PersistentVolumeReclaimRetain, annClass),
		...
		},
		{
			...
			volumeWithClass("silver", []*v1.PersistentVolume{
				...
				newVolume("volume13-3-2", "10Gi", "", "", v1.VolumePending, v1.PersistentVolumeReclaimRetain, annClass),
			}),
			volumeWithClass("silver", []*v1.PersistentVolume{
				newVolume("volume13-3-1", "1Gi", "", "", v1.VolumePending, v1.PersistentVolumeReclaimRetain),
				newVolume("volume13-3-2", "10Gi", "uid13-3", "claim13-3", v1.VolumeBound, v1.PersistentVolumeReclaimRetain, annBoundByController, annClass),
			}),
			newClaimArray("claim13-3", "uid13-3", "1Gi", "", v1.ClaimPending, annClass),
			withExpectedCapacity("10Gi", newClaimArray("claim13-3", "uid13-3", "1Gi", "volume13-3-2", v1.ClaimBound, annBoundByController, annBindCompleted, annClass)),
			noevents, noerrors, testSyncClaim,
		},
		{
