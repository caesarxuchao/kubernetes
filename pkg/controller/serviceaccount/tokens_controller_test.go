...
func TestTokenCreation(t *testing.T) {
	testcases := map[string]struct {
		...
		"new serviceaccount with no secrets": {
			...
			ExpectedActions: []core.Action{
				core.NewGetAction(unversioned.GroupVersionResource{Resource: "serviceaccounts"}, v1.NamespaceDefault, "default"),
				core.NewCreateAction(unversioned.GroupVersionResource{Resource: "secrets"}, v1.NamespaceDefault, createdTokenSecret()),
				core.NewUpdateAction(unversioned.GroupVersionResource{Resource: "serviceaccounts"}, v1.NamespaceDefault, serviceAccount(addTokenSecretReference(emptySecretReferences()))),
			},
		},
		"new serviceaccount with no secrets encountering create error": {
			...
			Reactors: []reaction{{
				...
				reactor: func(t *testing.T) core.ReactionFunc {
					...
					return func(core.Action) (bool, runtime.Object, error) {
						i++
						if i < 3 {
							return true, nil, apierrors.NewForbidden(v1.Resource("secrets"), "foo", errors.New("No can do"))
						}
			...
			ExpectedActions: []core.Action{
				...
				// Attempt 2
				core.NewGetAction(unversioned.GroupVersionResource{Resource: "serviceaccounts"}, v1.NamespaceDefault, "default"),
				core.NewCreateAction(unversioned.GroupVersionResource{Resource: "secrets"}, v1.NamespaceDefault, namedCreatedTokenSecret("default-token-gziey")),

				// Attempt 3
				core.NewGetAction(unversioned.GroupVersionResource{Resource: "serviceaccounts"}, v1.NamespaceDefault, "default"),
				core.NewCreateAction(unversioned.GroupVersionResource{Resource: "secrets"}, v1.NamespaceDefault, namedCreatedTokenSecret("default-token-oh43e")),
				core.NewUpdateAction(unversioned.GroupVersionResource{Resource: "serviceaccounts"}, v1.NamespaceDefault, serviceAccount(addNamedTokenSecretReference(emptySecretReferences(), "default-token-oh43e"))),
			},
		},
		...
		"new serviceaccount with missing secrets": {
			...
			ExpectedActions: []core.Action{
				core.NewGetAction(unversioned.GroupVersionResource{Resource: "serviceaccounts"}, v1.NamespaceDefault, "default"),
				core.NewCreateAction(unversioned.GroupVersionResource{Resource: "secrets"}, v1.NamespaceDefault, createdTokenSecret()),
				core.NewUpdateAction(unversioned.GroupVersionResource{Resource: "serviceaccounts"}, v1.NamespaceDefault, serviceAccount(addTokenSecretReference(missingSecretReferences()))),
			},
		},
		"new serviceaccount with non-token secrets": {
			...
			ExpectedActions: []core.Action{
				core.NewGetAction(unversioned.GroupVersionResource{Resource: "serviceaccounts"}, v1.NamespaceDefault, "default"),
				core.NewCreateAction(unversioned.GroupVersionResource{Resource: "secrets"}, v1.NamespaceDefault, createdTokenSecret()),
				core.NewUpdateAction(unversioned.GroupVersionResource{Resource: "serviceaccounts"}, v1.NamespaceDefault, serviceAccount(addTokenSecretReference(regularSecretReferences()))),
			},
		},
		...
		"deleted serviceaccount with token secrets": {
			...
			ExpectedActions: []core.Action{
				core.NewDeleteAction(unversioned.GroupVersionResource{Resource: "secrets"}, v1.NamespaceDefault, "token-secret-1"),
			},
		},
		...
		"added token secret without token data": {
			...
			ExpectedActions: []core.Action{
				core.NewGetAction(unversioned.GroupVersionResource{Resource: "secrets"}, v1.NamespaceDefault, "token-secret-1"),
				core.NewUpdateAction(unversioned.GroupVersionResource{Resource: "secrets"}, v1.NamespaceDefault, serviceAccountTokenSecret()),
			},
		},
		...
		"deleted secret with serviceaccount with reference": {
			...
			ExpectedActions: []core.Action{
				core.NewGetAction(unversioned.GroupVersionResource{Resource: "serviceaccounts"}, v1.NamespaceDefault, "default"),
				core.NewUpdateAction(unversioned.GroupVersionResource{Resource: "serviceaccounts"}, v1.NamespaceDefault, serviceAccount(emptySecretReferences())),
			},
		},
