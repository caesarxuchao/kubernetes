...
func newService(name string, uid types.UID, serviceType v1.ServiceType) *v1.Service {
	return &v1.Service{ObjectMeta: v1.ObjectMeta{Name: name, Namespace: "namespace", UID: uid, SelfLink: testv1.Default.SelfLink("services", name)}, Spec: v1.ServiceSpec{Type: serviceType}}
}
		...
		},
		{
			service: &v1.Service{
				ObjectMeta: v1.ObjectMeta{
					Name:      "udp-service",
					Namespace: "default",
					SelfLink:  testv1.Default.SelfLink("services", "udp-service"),
				},
				Spec: v1.ServiceSpec{
		...
		},
		{
			service: &v1.Service{
				ObjectMeta: v1.ObjectMeta{
					Name:      "basic-service1",
					Namespace: "default",
					SelfLink:  testv1.Default.SelfLink("services", "basic-service1"),
				},
				Spec: v1.ServiceSpec{
					Ports: []v1.ServicePort{{
						Port:     80,
