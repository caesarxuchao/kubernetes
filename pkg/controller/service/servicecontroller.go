...
import (
	...
	unversioned_core "k8s.io/client-go/1.5/kubernetes/typed/core/v1"
	"k8s.io/client-go/1.5/pkg/api"
	"k8s.io/client-go/1.5/pkg/api/errors"
	"k8s.io/client-go/1.5/pkg/api/v1"
	pkg_runtime "k8s.io/client-go/1.5/pkg/runtime"
...
func (s *ServiceController) Run(workers int) {
	...
	nodeLW := cache.NewListWatchFromClient(s.kubeClient.(*clientset.Clientset).CoreClient, "nodes", v1.NamespaceAll, fields.Everything())
