...
func TestAttach(t *testing.T) {
	version := scheme.Registry.GroupOrDie(api.GroupName).GroupVersion.Version
	tests := []struct {
	...
	for _, test := range tests {
		...
		tf.Namespace = "test"
		tf.ClientConfig = &restclient.Config{APIPath: "/api", ContentConfig: restclient.ContentConfig{NegotiatedSerializer: scheme.Codecs, GroupVersion: &schema.GroupVersion{Version: test.version}}}
