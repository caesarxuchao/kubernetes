	...
	if err == nil {
		mapper = meta.FirstHitRESTMapper{
			MultiRESTMapper: meta.MultiRESTMapper{
				discovery.NewDeferredDiscoveryRESTMapper(discoveryClient, scheme.Registry.InterfacesFor),
				scheme.Registry.RESTMapper(), // hardcoded fall back
			},
		}
