...
func TestUpdateRcWithRetries(t *testing.T) {
	...
	clientConfig := &restclient.Config{APIPath: "/api", ContentConfig: restclient.ContentConfig{NegotiatedSerializer: scheme.Codecs, GroupVersion: &scheme.Registry.GroupOrDie(api.GroupName).GroupVersion}}
