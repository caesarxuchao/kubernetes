...
var _ = framework.KubeDescribe("MetricsGrabber", func() {
	...
	It("should grab all metrics from a Scheduler.", func() {
		...
		if !masterRegistered {
			framework.Logf("Master is node scheme.Registry. Skipping testing Scheduler metrics.")
			return
		}
	...
	It("should grab all metrics from a ControllerManager.", func() {
		...
		if !masterRegistered {
			framework.Logf("Master is node scheme.Registry. Skipping testing ControllerManager metrics.")
			return
		}
