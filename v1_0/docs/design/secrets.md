...
[Service Accounts](http://docs.k8s.io/design/service_accounts.html) are proposed as a
...
Every pod will have a [security context](http://docs.k8s.io/design/security_context.html).
...
3.  [Kubernetes service account proposal](http://docs.k8s.io/design/service_accounts.html)
