...
Note the difference between a [container](http://docs.k8s.io/containers.html)
and a [pod](http://docs.k8s.io/pods.html). Since you only asked for the former, kubernetes will create a wrapper pod for you.
